...
@php
    $active_category_slug = Session::get('active_category_slug');
@endphp
    ...
    <div class="select-input">
        ...
        <ul class="select-input__list">
            <li class="select-input__item">
                <a href="{{ url('filter-category-price/' . $active_category_slug . '/'. 'low_to_hight') }}" class="select-input__link">Giá: thấp đến cao</a>
            </li>
            <br>
            <li class="select-input__item">
                <a href="{{ url('filter-category-price/' . $active_category_slug . '/'. 'hight_to_low') }}" class="select-input__link">Giá: cao đến thấp</a>
            </li>                            
        </ul>
    </div>
</div>
