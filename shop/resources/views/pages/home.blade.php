    ...
    <div class="select-input">
        ...
        <ul class="select-input__list">
            <li class="select-input__item">
                <a href="{{ URL::to('filter-price/low-to-hight') }}" class="select-input__link">Giá: thấp đến cao</a>
            </li>
            <br>
            <li class="select-input__item">
                <a href="{{ URL::to('filter-price/hight-to-low') }}" class="select-input__link">Giá: cao đến thấp</a>
            </li>                            
        </ul>
    </div>    
</div>
        ...
        <div class="grid__row1">
            @foreach ($all_product as $key => $product)
                ...
                <div class="grid__column-2-4">
                    <a class="home-product-item" href="{{ url('chi-tiet-san-pham/'.$product->product_slug) }}">
